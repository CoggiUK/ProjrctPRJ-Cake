<%-- 
    Document   : login
    Created on : Mar 5, 2023, 11:17:20 PM
    Author     : pc
--%>
...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto mx-lg-auto py-0">
                    ...
                    <a href="team.jsp" class="nav-item nav-link">Chef</a>
                    <a href="service.jsp" class="nav-item nav-link">Service</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Log in/Register</a>
                        <div class="dropdown-menu m-0">
                            <a href="login.jsp" class="dropdown-item active">Log in</a>
                ...
                <form action="login" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input value="" name="pass" type="password" class="form-control" required>
                        </div>
        ...
        <!-- Login end -->
    <!-- Footer Start -->
    <div class="container-fluid bg-dark bg-img text-secondary" style="margin-top: 150px">
        <div class="container">
            <div class="row gx-5">
