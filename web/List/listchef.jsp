<%-- 
    Document   : listchef
    Created on : Mar 7, 2023, 11:10:32 PM
    Author     : pc
--%>
                ...
                <div class="navbar-nav ms-auto mx-lg-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="../List/listcake.jsp" class="dropdown-item ">list cake</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Chefs</a>
                        <div class="dropdown-menu m-0">
                            <a href="../List/listchef.jsp" class="dropdown-item active">List chef</a>
...
<div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="display-4 text-uppercase text-white">List chef</h1>
            <a href="../index.jsp">Home</a>
            <i class="far fa-square text-primary px-2"></i>
            <a href="../List/listchef.jsp">List chef</a>
        </div>
    </div>
</div>
<!-- Page Header End -->

<h2 align="center"> List of Chef </h2>
<table border="1" align="center">
    <tr>
        <td align="center"> Name </td>
        <td align="center"> img </td>
        <td align="center"> chuyen mon </td>
