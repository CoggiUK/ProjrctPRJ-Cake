...
<div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            ...
            <a href="../admin/addchef.jsp">Add chef</a>
        </div>
    </div>
</div>
<!-- Page Header End -->
    ...
    <div class="modal-content">
        <form action="../addchef" method="POST">
            <div class="modal-header">						
                <h4 class="modal-title">Add Chef</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>img</label>
                    <input value="" name="img" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>ChuyenMon</label>
                    <input value="" name="ChuyenMon" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Gender</label>
                ...
                <div class="form-group">
                    <label>rate</label>
                    <input value="" name="rate" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>IdChef</label>
                    <input value="" name="IdChef" type="text" class="form-control" required>
                </div>
            </div>
            <div class="modal-footer">
                <p><input type="submit" value="add chef"> 
            </div>
        </form>
    </div>
</div>
