...
<div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            ...
            <a href="../admin/addCustom.jsp">Add cake</a>
        </div>
    </div>
</div>
<!-- Page Header End -->
        ...
        <form action="../addCustom" method="POST">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Name</label>
                    <input value="" name="nameC" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Price</label>
                    <input value="" name="priceC" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>img</label>
                    <input value="" name="imgC" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>IdChef</label>
