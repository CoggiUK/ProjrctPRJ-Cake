                ...
                <div class="tab-class text-center">
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            <ul class="nav nav-pills d-inline-flex justify-content-center bg-dark text-uppercase border-inner p-4 mb-5">
                                <li class="nav-item">
                                    <a href="../admin/addSN.jsp" class="nav-link text-white">Add Cake</a>                                </li>
                                <li class="nav-item">
                                    <a href="../admin/deleteSN.jsp" class="nav-link text-white">Delete Cake</a>                                </li>
                                </li>
                            </ul>                            
                            <div class="row g-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex h-100">
                                            ...
                                            <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                                ...
                                                <span>${s.idChef}</span>
                                                <a href="updateSN.jsp?nameS=${s.nameS}"  class="edit" title="Edit">Edit</a>
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <ul class="nav nav-pills d-inline-flex justify-content-center bg-dark text-uppercase border-inner p-4 mb-5">
                                <li class="nav-item">
                                    <a href="../admin/addTC.jsp" class="nav-link text-white">Add Cake</a>                                </li>
                                <li class="nav-item">
                                    <a href="../admin/deleteTC.jsp" class="nav-link text-white">Delete Cake</a>                                </li>
                                </li>
                            </ul>
                            <div class="row g-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex h-100">
                                            ...
                                            <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                                ...
                                                <span>${t.idChef}</span>
                                                <a href="updateTC.jsp?nameT=${t.nameT}"  class="edit" title="Edit">Edit</a>
                        ...
                        <div id="tab-3" class="tab-pane fade show p-0">
                            <ul class="nav nav-pills d-inline-flex justify-content-center bg-dark text-uppercase border-inner p-4 mb-5">
                                <li class="nav-item">
                                    <a href="../admin/addCustom.jsp" class="nav-link text-white">Add Cake</a>                                </li>
                                <li class="nav-item">
                                    <a href="../admin/deleteCustom.jsp" class="nav-link text-white">Delete Cake</a>                                </li>
                                </li>
                            </ul>
                            <div class="row g-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex h-100">
                                            ...
                                            <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                                ...
                                                <span>${c.idChef}</span>
                                                <a href="updateCustom.jsp?nameC=${c.nameC}"  class="edit" title="Edit">Edit</a>
