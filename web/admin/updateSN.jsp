...
<div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            ...
            <a href="../admin/updateSN.jsp">Update cake</a>
        </div>
    </div>
</div>
<!-- Page Header End -->
...
<%
    ...
    SinhNhatDAO sinhnhatDAO = new SinhNhatDAO();
        SinhNhat s = sinhnhatDAO.getSinhNhat(xNameS);
        request.setAttribute("detail", s);
%>
<div id="editEmployeeModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="../updateSN" method="post">
                ...
                <div class="modal-body">					
                    ...
                    <div class="form-group">
                        <label>Cake</label>
                        <input value="${detail.nameS}" name="nameS" type="text" class="form-control" readonly required>
                    </div>
                    <div class="form-group">
                        <label>Price</label>
                        <input value="${detail.priceS}" name="priceS" type="text" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label>Img</label>
                        <input value="${detail.imgS}" name="imgS" type="text" class="form-control" required>
                    </div>
