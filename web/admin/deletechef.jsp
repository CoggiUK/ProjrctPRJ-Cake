<%-- 
    Document   : addchef
    Created on : Mar 7, 2023, 10:56:04 PM
    Author     : pc
--%>
...
<!DOCTYPE html>
<%
    DauBepDAO s = new DauBepDAO();
    List<DauBep> lstDB = s.getDauBepList();
%> 
<html lang="en">
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto mx-lg-auto py-0">
                    ...
                    <a href="../admin/team.jsp" class="nav-item nav-link active">Chefs</a>
...
<div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="display-4 text-uppercase text-white">Delete chef</h1>
            <a href="../index.jsp">Home</a>
            <i class="far fa-square text-primary px-2"></i>
            <a href="../admin/deletechef.jsp">Delete chef</a>
        </div>
    </div>
</div>
<!-- Page Header End -->
    ...
    <div class="modal-content">
        <form action="../deleteChef" method="POST">
            <div class="modal-header">						
                <h4 class="modal-title">Delete Chef</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Chef</label>
                    <input value="" name="Chef" type="text" class="form-control" required>
                </div>
                
            <div class="modal-footer">
                <p><input type="submit" value="delete chef"> 
            </div>
        </form>
    </div>
</div>
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="admin/service.html"><i class="bi bi-arrow-right text-primary me-2"></i>Service</a>                            <a class="text-secondary mb-2" href="logout"><i class="bi bi-arrow-right text-primary me-2"></i>Log out</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
