<%-- 
    Document   : team
    Created on : Mar 1, 2023, 8:25:01 AM
    Author     : pc
--%>
...
<!DOCTYPE html>
<%
  DauBepDAO i = new DauBepDAO();
  List<DauBep> lstB = i.getDauBepList();
        ...
        <div class="container-fluid bg-dark bg-img p-5 mb-5">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="display-4 text-uppercase text-white">Chefs</h1>
                    <a href="../index.jsp">Home</a>
                    <i class="far fa-square text-primary px-2"></i>
                    <a href="../admin/team.jsp">Chefs</a>
                </div>
            </div>
        </div>
        <!-- Page Header End -->
        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                    ...
                    <ul class="nav nav-pills d-inline-flex justify-content-center bg-dark text-uppercase border-inner p-4 mb-5 center">
                        <li class="nav-item">
                            <a href="../admin/addchef.jsp" class="nav-link text-white">Add Chef</a>                                
                        </li>
                        <li class="nav-item">
                            <a href="../admin/deletechef.jsp" class="nav-link text-white">Delete Chef</a>                                
                        </li>
                    </ul>
                </div>
                    ...
                    <tbody>
                        <c:forEach var="b" items="${lstB}">
                            <tr>
                                ...
                                <td>${b.rate}</td>
                                <td>
                                    <a href="updatechef.jsp?Chef=${b.chef}"  class="edit" title="Edit">Edit</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
