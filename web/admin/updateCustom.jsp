...
<div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            ...
            <a href="../admin/updateCustom.jsp">Update cake</a>
        </div>
    </div>
</div>
<!-- Page Header End -->
...
<%
    ...
    CustomDAO customDAO = new CustomDAO();
        Custom c = customDAO.getCustom(xNameC);
            ...
            <form action="../updateCustom" method="post">
                ...
                <div class="modal-body">					
                    ...
                    <div class="form-group">
                        <label>Cake</label>
                        <input value="${detail.nameC}" name="nameC" type="text" class="form-control" readonly required>
                    </div>
                    <div class="form-group">
                        <label>Price</label>
                        <input value="${detail.priceC}" name="priceC" type="text" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label>Img</label>
                        <input value="${detail.imgC}" name="imgC" type="text" class="form-control" required>
                    </div>
