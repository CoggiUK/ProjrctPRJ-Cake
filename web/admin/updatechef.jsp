...
<div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="display-4 text-uppercase text-white">Update chef</h1>
            <a href="../index.jsp">Home</a>
            <i class="far fa-square text-primary px-2"></i>
            <a href="../admin/updatechef.jsp">Update chef</a>
        </div>
    </div>
</div>
<!-- Page Header End -->
...
<%
    ...
    DauBepDAO dauBepDAO = new DauBepDAO();
        DauBep p = dauBepDAO.getDauBep(xChef);
        ...
        <div class="modal-content">
            <form action="../updatechef" method="post">
                <div class="modal-header">						
                    <h4 class="modal-title">Update Chef</h4>
                </div>
                <div class="modal-body">					
                    <div class="form-group">
                        <label>ID Chef</label>
                        <input value="${detail.idChef}" name="IdChef" type="text" class="form-control" readonly required>
                    </div>
                    <div class="form-group">
                        <label>Chef</label>
                        <input value="${detail.chef}" name="Chef" type="text" class="form-control" readonly required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="${detail.chuyenMon}" name="ChuyenMon" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Gender</label>
