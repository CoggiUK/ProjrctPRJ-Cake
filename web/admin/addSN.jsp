...
<div class="container-fluid bg-dark bg-img p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="display-4 text-uppercase text-white">Add cake</h1>
            <a href="../index.jsp">Home</a>
            <i class="far fa-square text-primary px-2"></i>
            <a href="../admin/addSN.jsp">Add cake</a>
        </div>
    </div>
</div>
<!-- Page Header End -->
...
<div class="modal-dialog">
    <div class="modal-content">
        <form action="../addSN" method="POST">
            <div class="modal-header">						
                <h4 class="modal-title">Add Cake</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Name</label>
                    <input value="" name="nameS" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Price</label>
                    <input value="" name="priceS" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>img</label>
                    <input value="" name="imgS" type="text" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>IdChef</label>
            ...
            <div class="modal-footer">
                <p><input type="submit" value="add cake"> 
            </div>
        </form>
    </div>
</div>
